...
from assets.param_map import WINDOW_WIDTH, PLAYER_SCALING, MOVEMENT_SPEED
...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        phl = os.path.join(os.path.dirname(os.path.abspath(__file__)), "PHL.tmx")

        # Charger la carte TMX
        self.tile_map = arcade.load_tilemap(phl, scaling=1.0)
        ...
        self.player_sprite.center_x = 574
